...
import (
	...
	"github.com/shadowdara/finder/internal/bt/config"
	conf "github.com/shadowdara/finder/internal/bt/config"
	"github.com/shadowdara/finder/internal/bt/core"
	"github.com/shadowdara/finder/internal/bt/gitrepo"
	"github.com/shadowdara/finder/internal/bt/scriptcompiler"
...
func ParseArgs() {
	...
	default:
		conf.Banner()
		fmt.Println("CSF Version " + core.GetVersion() + " by Shadowdara")
		cmd.PrintHelp()
	}
}
